...
\icmltitlerunning{Exponential family tensor regression}
\usepackage{wrapfig}
\usepackage{multirow}
\usepackage{graphicx}
...
\twocolumn[
\icmltitle{Exponential Family Tensor Regression with Covariates on Multiple Modes}
...
\icmlkeywords{Higher-order tensors, tensor regression, exponential family, supervised learning}
...
\begin{figure}[t]
\includegraphics[width=8cm]{dimension.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=8cm]{comparison.pdf}
...
\begin{figure}[t]
\includegraphics[width=.5\textwidth]{merge.pdf} 
\vspace{-.5cm}
...
\newpage
\bibliography{tensor_regression.bbl}
