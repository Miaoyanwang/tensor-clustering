...
binary_tensor_fctr_km = function(tensor,k,maxiter){
  ...
  #here use tucker
  inital_tucker = tucker(as.tensor(tensor),ranks = k)
  C_0 = inital_tucker$Z
...
problem = test$mode_problem$mode_p$p3#p3 means the third upgrading step sth wrong
cor(problem$M2)#the third step corresponds to upgrade M2 or B in our document
