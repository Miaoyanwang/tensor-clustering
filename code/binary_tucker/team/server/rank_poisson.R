...
rank_range=array(0,dim=c(3,6,3))
rank_range[1,,]=rbind(c(3,3,3),c(3,3,2),c(3,2,2),c(2,2,2),c(3,4,3),c(2,3,4))
rank_range[2,,]=rbind(c(4,4,6),c(4,4,5),c(3,3,6),c(3,3,5),c(3,4,6),c(4,5,6))
rank_range[3,,]=rbind(c(6,8,8),c(6,7,7),c(7,8,8),c(5,7,7),c(5,8,8),c(5,6,7))
