...
F1_normal=conv_rate(seed,signal=10,cons="non",alpha=10,c_range=c_range,dist="normal",dup=10,d_range=d_range,p_range=p_range,naive=FALSE)

#F1_binary=conv_rate(seed,signal=3,Nsim=10,cons="non",c_range=c_range,dist="binary",alpha=10,dup=5,d_range=d_range,p_range=p_range,naive=FALSE)

#F1_poisson=conv_rate(seed,signal=1,Nsim=10,cons="non",c_range=c_range,dist="poisson",alpha=10,dup=5,d_range=d_range,p_range=p_range,naive=FALSE)
