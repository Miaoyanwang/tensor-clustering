...
method = "original"
verlam = chooseLambda(test,k,r,l,lambda=lambda,method=method,sim.times=10)
verlam = chooseLambda(test,k,r,l,lambda=3000,method=method,sim.times=10)
...
sim = label2(test,4,5,1,threshold=5e-2,lambda=verlam$lambda,sim.times=5,trace=FALSE)
judgeX = sim$judgeX
...
tc = label2(test,4,5,1,threshold=1e-10,lambda=3000,sim.times=5,trace=FALSE)
