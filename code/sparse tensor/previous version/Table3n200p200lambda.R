...
install.packages("sparseBCnew_1.2.tar.gz", repos=NULL, type="source")#restart R after running this line
rm(list = ls())
...
bicluster5<-Do(n=n,p=p,k=4,r=5,iteration=iter,lambda=lambda,standarddeviation=sd,center=FALSE,method="original")
