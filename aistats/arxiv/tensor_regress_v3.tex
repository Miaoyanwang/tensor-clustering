...
\tL_{\tY}(\tB)=\tL_{\tY}(\trueB)+\langle {\partial\tL_{\tY}(\tB) \over \tB}\big|_{\tB=\trueB},\tB-\trueB \rangle + {1\over 2}\text{vec}(\tB-\trueB)^T \tH(\check \tB)\text{vec}(\tB-\trueB),
\end{equation}
