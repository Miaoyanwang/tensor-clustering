...
\begin{center}
\begin{spacing}{1.5}
\textbf{\Large Supplements for ``Generalized tensor regression with \\
...
&\leq {U \over 2}c^2_2\FnormSize{}{\tB-\trueB}^2,
\end{align}
