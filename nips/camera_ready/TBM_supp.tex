...
\begin{align}\label{inq:1}
 ...
 %\leq& \mathbb{P}\left( G(\mD^{(1)}, \ldots,\mD^{(K)})-\displaystyle\sum_{r_1,\ldots,r_K}p_{r_1,\text{true}}^{(1)}\cdot\cdot\cdot p_{r_K,\text{true}}^{(K)}c^2_{r_1,\ldots,r_K}\leq -\frac{1}{2}\varepsilon\tau^{K-1}\delta_{\min}\right)\notag \\
...
\begin{align}\label{inq:3}
    ...
    \leq & \mathbb{P}\left(r \geq\frac{\varepsilon\tau^{K-1}\delta_{\min}}{4}\right),
\end{align}
where the last line uses the fact that the ${\widehat{\mM}_k}$ is the global optimizer of $F(\cdot)$; i.e. $F(\widehat{\mM}_1,\ldots,\widehat {\mM}_K)=\arg\max F(\mM_1,\ldots,\mM_K)\geq F(\mM_{1,\text{true}},\ldots,\hat \mM_{K,\text{true})$.
...
%&=|\displaystyle\sum_{r_1,\ldots,r_K}\hat{p}_{r_1}^{(1)}\hat{p}_{r_2}^{(2)}\cdots\hat{p}_{r_K}^{(K)}[f(\overline{Y_{r_1,\ldots,r_K}})-f(E_{r_1,\ldots,r_K})]|\\
\leq&\sum_{r_1,\ldots,r_K}p_{r_1}^{(1)}p_{r_2}^{(2)}\cdots p_{r_K}^{(K)}\left|f(\hat c_{r_1,\ldots,r_K})-f(\mu_{r_1,\ldots,r_K})\right|\notag \\
%&\leq& c\sum_{r_1,\ldots,r_K}\hat{p}_{r_1}^{(1)}\hat{p}_{r_2}^{(2)}\cdots\hat{p}_{r_K}^{(K)}|R(\mM_1,\ldots,\mM_K)_{r_1,\ldots,r_K}|\\
