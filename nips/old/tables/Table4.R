...
i=2
min(result$mus[,,i])
which(result$mus[,,i]<=min(result$mus[,,i]),arr.ind=T)

c(max(result$mus[,,i]),min(result$mus[,,i]))
i=1
max(result$mus[,,i])
which(result$mus[,,i]>=max(result$mus[,,i]),arr.ind=T)
